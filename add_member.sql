...
BEGIN
    ...
    SELECT MAX(member_id) + 1 INTO member_id FROM Members;
    IF member_id IS NULL THEN
        member_id := 1;
    END IF;

    INSERT INTO Members (member_id, name, semester, year, contact_details, membership_type, no_of_books_taken, total_fines,paid_fees)
